        ...
        <Card elevation={6}>
            ...
            <CardContent>
                ...
                <Box display="flex" justifyContent="space-between">
                    ...
                    <Typography gutterBottom variant="subtitle1">{place.num_reviews} değerlendirme arasından</Typography>
                </Box>
                <Box display="flex" justifyContent="space-between">
                ...
                <CardActions>
                    ...
                    <Button size="small" color="primary" onClick={() => window.open(place.website, '_blank')}>Web Sitesi</Button>
                </CardActions>
